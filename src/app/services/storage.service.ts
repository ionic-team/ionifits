...
export class StorageService {
  ...
  async readTheme(): Promise<string | undefined> {
    return (await this._storage.get(this.THEME)) || undefined;
  }

  async replaceTheme(theme: string) {
    await this._storage.set(this.THEME, theme);
  }

  async deleteTheme() {
    await this._storage.remove(this.THEME);
  }
}
